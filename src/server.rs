...
impl Server {
    ...
    pub async fn cmd_with_output(&self, id: &str, cmd: &str, working_dir: Option<&str>) -> Result<String> {
        match self.workspaces.get(id) {
    ...
    pub async fn write_file(&self, id: &str, path: &str, content: &str, working_dir: Option<&str>) -> Result<()> {
        match self.workspaces.get(id) {
    ...
    pub async fn read_file(&self, id: &str, path: &str, working_dir: Option<&str>) -> Result<String> {
        match self.workspaces.get(id) {
    ...
    pub async fn workspace_cmd_with_output(&self, id: &str, cmd: &str, working_dir: Option<&str>) -> Result<String> {
        match self.workspaces.get(id) {
            Some(controller) => controller.cmd_with_output(cmd, working_dir).await,
            None => Err(anyhow::anyhow!("Workspace not found: {}", id)),
        }
    ...
    pub async fn workspace_write_file(&self, id: &str, path: &str, content: &str, working_dir: Option<&str>) -> Result<()> {
        match self.workspaces.get(id) {
            Some(controller) => controller.write_file(path, content, working_dir).await,
            None => Err(anyhow::anyhow!("Workspace not found: {}", id)),
        }
    ...
    pub async fn workspace_read_file(&self, id: &str, path: &str, working_dir: Option<&str>) -> Result<String> {
        match self.workspaces.get(id) {
            Some(controller) => controller.read_file(path, working_dir).await,
            None => Err(anyhow::anyhow!("Workspace not found: {}", id)),
        }
